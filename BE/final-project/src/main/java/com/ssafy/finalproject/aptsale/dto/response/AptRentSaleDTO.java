...
public class AptRentSaleDTO {
    ...
    public AptRentSaleDTO(int constructionYear, String contractType, String contractPeriod, int year,
                          String legalDong, String depositAmount, String apartmentName, int month,
                          String monthlyRent, int day, double exclusiveArea, String previousContractDeposit,
                          String previousContractRent, String regionCode, int floor) {
