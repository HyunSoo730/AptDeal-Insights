     ...
     <div class="lg:col-span-2">
       ...
       <div v-if="selectedApartment" class="mt-8">
         ...
         <div class="review-section">
           ...
           <p v-else>리뷰가 없습니다.</p>
           <button v-if="reviews.length > visibleReviews.length"
       ...
       <div class="detail-container bg-white shadow-lg rounded-lg p-6">
         ...
         <div class="apartment-details space-y-4">
           ...
           <div v-if="apartmentDetails" class="info-cards grid grid-cols-1 gap-4">
             <div v-for="(detail, index) in visibleDetails" :key="detail.aptCode" class="info-card bg-gray-100 p-4 rounded-lg">
           ...
           <button v-if="apartmentDetails && apartmentDetails.length > 3 && visibleDetails.length < apartmentDetails.length"
